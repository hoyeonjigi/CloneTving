...
function ProfilesForEdit() {
  ...
  const { isImageSelected, setIsImageSelected, selectedImageId } = useCreate();
    ...
    try {
      ...
      setUserProfiles(
        result.map((item) => ({
          ...
          profileImageUrl: `https://hoyeonjigi.s3.ap-northeast-2.amazonaws.com${item.profileImageUrl}`,
