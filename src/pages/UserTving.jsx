  ...
  return (
    <div className="bg-black flex flex-col">
      ...
      <div className="md-h lg-h">
        <div className="flex flex-col text-center mb-12 mt-12">
        ...
        <div className="flex flex-col items-center justify-center gap-3">
          <Link to="/signIn" className="w-[37%]">
            <button className="relative border border-[#4e4e4e] text-[#a3a3a3] w-full py-4 text-lg rounded-sm hover:text-[#dedede] hover:border-[#888888]">
              <img
                src={tving}
                alt="티빙 아이콘"
                className="absolute top-[28%] left-[3%] w-[1.7rem]"
              />
              TVING ID 시작하기
            </button>
          </Link>
        ...
        <div className="flex flex-row items-center justify-center mt-10 mb-36">
          ...
          <Link to="/FindID" className="text-[#A3A3A3] hover:text-[#dedede]">
            아이디 찾기
          </Link>
        </div>
      </div>
