...
// function Detail() {
//   const { content, genre, setGenre, setContent } = useContents();
//   const {
//     review,
//     numberOfReviews,
//     averageRating,
...
//             <button
//               onClick={openModal}
//               className="border-2 border-gray_05 hover:border-white text-white px-10 py-2 font-bold rounded-full"
//             >
//               리뷰 작성
//             </button>
...
//                     {item.profileName} • {item.ratingDate.split("T")[0]}{" "}
//                   </span>
//                 </li>
//               ))
//             ) : (
